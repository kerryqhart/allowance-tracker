...
impl ExportService {
    ...
    pub async fn export_transactions_csv<C: Connection>(
        &self,
        ...
        let child = match child_service.get_child(get_child_command).await? {
        ...
        let domain_res = transaction_service.list_transactions_domain(domain_query).await?;
    ...
    pub async fn export_to_path<C: Connection>(
        ...
        let export_response = self.export_transactions_csv(export_request, child_service, transaction_service).await?;
